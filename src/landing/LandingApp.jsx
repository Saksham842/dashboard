...
export default function LandingApp() {
  ...
  return (
    ...
    <div className="ih-landing">
      ...
      {/* Book a Demo CTA */}
      <section data-scroll style={{ background:'#000', padding:'clamp(80px,10vw,140px) clamp(16px,4vw,48px)', textAlign:'center', position:'relative', overflow:'hidden', borderTop:'1px solid rgba(217,100,36,0.08)' }}>
        <div style={{ position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)', width:600, height:400, background:'radial-gradient(ellipse, rgba(217,100,36,0.04) 0%, transparent 70%)', pointerEvents:'none' }}/>
        <div style={{ position:'absolute', top:'15%', left:'8%', width:6, height:6, borderRadius:'50%', background:'#d96424', pointerEvents:'none', boxShadow:'0 0 12px rgba(217,100,36,0.6)', animation:'ctaSparkle1 3s ease-in-out infinite 0.5s' }} />
        <div style={{ position:'absolute', bottom:'20%', right:'5%', width:8, height:8, borderRadius:'50%', background:'#d96424', pointerEvents:'none', boxShadow:'0 0 10px rgba(217,100,36,0.5)', animation:'ctaSparkle2 4s ease-in-out infinite 1s' }} />
        <div style={{ position:'absolute', top:'30%', right:'12%', width:4, height:4, borderRadius:'50%', background:'#d96424', pointerEvents:'none', boxShadow:'0 0 8px rgba(217,100,36,0.5)', animation:'ctaSparkle1 3.5s ease-in-out infinite 0.8s' }} />
        <div style={{ position:'absolute', bottom:'40%', left:'4%', width:5, height:5, borderRadius:'50%', background:'#d96424', pointerEvents:'none', boxShadow:'0 0 10px rgba(217,100,36,0.5)', animation:'ctaSparkle2 2.8s ease-in-out infinite 0.3s' }} />
        <div style={{ position:'relative', zIndex:2 }}>
          ...
          <button
            ...
            style={{
              ...
              background:'linear-gradient(135deg, #d96424, #ba5520)', color:'#000',
              border:'none', borderRadius:12, padding:'16px 36px', cursor:'pointer',
              boxShadow:'0 0 30px rgba(217,100,36,0.25)', opacity:0,
