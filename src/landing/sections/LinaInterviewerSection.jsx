...
export default function LinaInterviewerSection() {
  const [activeSignal, setActiveSignal] = useState(0);

  useEffect(() => {
    const id = setInterval(() => setActiveSignal(i => (i + 1) % SIGNALS.length), 2200);
  ...
  return (
    <section style={{ position:'relative', width:'100%', background:T.bg, padding:'clamp(30px,4vw,60px) clamp(16px,4vw,48px)', overflow:'hidden' }}>
      <div style={{ position:'relative', margin:'0 auto', maxWidth:1100 }}>
        ...
        <p style={{ fontFamily:'Space Grotesk,sans-serif', fontWeight:900, fontSize:'clamp(1.6rem,3vw,2.6rem)', lineHeight:1.15, letterSpacing:'-0.02em', textAlign:'center', color:T.pink, margin:'12px 0 0' }}>
            ...
            <div style={{
              ...
              <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', borderBottom:'1px solid rgba(255,255,255,0.08)', paddingBottom:16 }}>
                <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                  <div style={{ width:40, height:40, borderRadius:'50%', background:T.white, display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'Space Grotesk,sans-serif', fontSize:14, fontWeight:700, color:T.bg }}>L</div>
                  <div>
                ...
                <span style={{ display:'flex', alignItems:'center', gap:6, background:'rgba(255,255,255,0.04)', borderRadius:99, padding:'4px 10px', fontFamily:'Inter,sans-serif', fontSize:10, fontWeight:600, letterSpacing:'0.06em', color:T.white }}>
              ...
              <div style={{ marginTop:20, display:'flex', flexDirection:'column', gap:12 }}>
                <div style={{ background:'rgba(0,0,0,0.6)', borderRadius:10, padding:14 }}>
                  <p style={{ fontFamily:'Inter,sans-serif', fontSize:11, letterSpacing:'0.06em', textTransform:'uppercase', color:T.muted, margin:'0 0 4px' }}>Lina asks</p>
                ...
                <div style={{ background:'rgba(0,0,0,0.35)', borderRadius:10, padding:14 }}>
                  <p style={{ fontFamily:'Inter,sans-serif', fontSize:11, letterSpacing:'0.06em', textTransform:'uppercase', color:T.muted, margin:'0 0 4px' }}>Follow-up queued</p>
