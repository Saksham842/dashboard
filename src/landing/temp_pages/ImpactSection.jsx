...
export const ImpactSection = () => {
  ...
  return (
    <section data-scroll style={{ background: '#0F0D07', padding: 'clamp(60px, 8vw, 120px) clamp(16px, 4vw, 48px)', position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 700, height: 400, background: 'radial-gradient(ellipse, rgba(217,100,36,0.06) 0%, transparent 70%)', pointerEvents: 'none' }}/>
      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative' }}>
            ...
            {doubleStats.map((s, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  lineHeight: 1,
                  marginBottom: 16,
                  background: 'linear-gradient(135deg, #d96424, #ba5520, #d96424)',
        ...
        <RevealCard delay={0.3}>
          <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: 16, color: '#555550', lineHeight: 1.7, maxWidth: 680, borderTop: '1px solid rgba(217,100,36,0.1)', paddingTop: 40 }}>
